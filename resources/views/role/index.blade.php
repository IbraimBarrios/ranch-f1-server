                    ...
                    <table class="table-auto w-full">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $role->description }}</td>

                                <td class="border px-4 py-2 text-center">
                                    <div class="flex justify-center">
                                        <a href="{{ route('roles.show', $role->id) }}" class="bg-green-500 dark:bg-green-700 hover:bg-green-600 dark:hover:bg-green-800 text-white font-bold py-2 px-4 rounded mr-2">Ver</a>
                                        <a href="{{ route('roles.edit', $role->id) }}" class="bg-violet-500 dark:bg-violet-700 hover:bg-violet-600 dark:hover:bg-violet-800 text-white font-bold py-2 px-4 rounded mr-2">Editar</a>
