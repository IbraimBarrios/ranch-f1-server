            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                ...
                @method('PUT')
                    ...
                    <div class="mb-5">
                        ...
                        <x-text-input id="first_name" name="first_name" type="text" class="mt-1 block w-full" :value="old('first_name', $profile->first_name)" required autofocus />
                    ...
                    <div class="mb-5">
                        ...
                        <x-text-input id="second_last_name" name="second_last_name" type="text" class="mt-1 block w-full" :value="old('second_last_name', $profile->second_last_name)" />
                    ...
                    <div class="mb-5">
                        ...
                        <x-text-input id="birth_date" name="birth_date" type="date" class="mt-1 block w-full" :value="old('birth_date', $profile->birth_date?->format('Y-m-d'))" required />
