        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                   <div class="mb-4">
                        <a href="{{ route('users.create') }}" class="bg-cyan-500 dark:bg-cyan-700 hover:bg-cyan-600 dark:hover:bg-cyan-800 text-white font-bold py-2 px-4 rounded">Crear usuario</a>
                    </div>
                    @if ($users->isNotEmpty())
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-cell-actions">
                                    ...
                                    <div class="table-actions">
                                        <a href="{{ route('users.show', $user) }}" class="bg-green-500 dark:bg-green-700 hover:bg-green-600 dark:hover:bg-green-800 text-white font-bold py-2 px-4 rounded text-center text-sm">
                                            Ver
                                        </a>
                                        <a href="{{ route('users.edit', $user) }}" class="bg-violet-500 dark:bg-violet-700 hover:bg-violet-600 dark:hover:bg-violet-800 text-white font-bold py-2 px-4 rounded text-center text-sm">
                                            Editar
                                        </a>
